 ...
 * java.time.format.DateTimeFormatter; import java.sql.Date; import
 ...
 * 
 * public class MasterData { public static Billes getBillesDetails() throws
 * ParseException { SimpleDateFormat formatter = new
 * SimpleDateFormat("dd-MM-yyyy"); Date dateOfEntry = (Date)
 * formatter.parse("15-Jun-2020"); Date dueDate = (Date)
 * formatter.parse("15-Jul-2020"); Billes billes = new Billes();
 * billes.setId((long) 1); billes.setBillTitle("phone");
 * billes.setCategory("vd"); billes.setAmount(100.0);
 * billes.setDateOfEntry(dateOfEntry); billes.setDueDate(dueDate);
 * 
 * billes.setPaid("no"); billes.setUnpaid("yes"); billes.setActive(true); return
 * billes; }
 * 
 ...
 * properties = getProperties(); BasicDataSource dataSource = new
 * BasicDataSource();
 ...
 * lsfb.setHibernateProperties(properties); try { lsfb.afterPropertiesSet(); }
 * catch (IOException e) { e.printStackTrace(); } return lsfb; }
 * 
 * public static Billes getBillDetails() { // TODO Auto-generated method stub
 * return null; } }
 */